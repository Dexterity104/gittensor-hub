          ...
          <Box sx={{ display: 'flex', gap: 2 }}>
            ...
            <Box
              ...
              sx={{
                ...
                bg: trackedOnly ? 'var(--attention-subtle, rgba(245, 158, 11, 0.14))' : 'var(--bg-canvas)',
              ...
              <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', alignItems: 'center' }}>
                ...
                <Box
                  ...
                  sx={{
                    ...
                    bg: prMineOnly ? 'var(--attention-subtle, rgba(245, 158, 11, 0.14))' : 'var(--bg-canvas)',
  ...
  return (
    <Box
      ...
      sx={{
        ...
        '&:hover': { bg: mine ? 'var(--attention-subtle, rgba(245, 158, 11, 0.14))' : 'var(--bg-subtle)' },
        cursor: 'pointer',
      }}
      onClick={onView}
    >
